...
// --- Компоненты выбора параметров ---
const TenButtons = ({ value, onChange, Icon }: any) => (
        ...
        <div className="bg-[#1a1a1d] p-6 rounded-2xl shadow-md space-y-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input type="number" value={pulse} onChange={(e) => setPulse(e.target.value)} className="w-full p-3 rounded-xl bg-[#0e0e10] border border-gray-700 text-white" />
            </div>
            <div>
            ...
            <div>
              ...
              <input type="text" value={sleepDuration} onChange={(e) => setSleepDuration(e.target.value)} className="w-full p-3 rounded-xl bg-[#0e0e10] border border-gray-700 text-white" />
            </div>
            <div>
              <p className="mb-2">Комментарии</p>
              <textarea value={comment} onChange={(e) => setComment(e.target.value)} className="w-full p-3 h-28 rounded-xl bg-[#0e0e10] border border-gray-700 text-white" />
            </div>
          </div>

          <button onClick={handleSave} className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-xl">
            Сохранить
          </button>
        </div>
