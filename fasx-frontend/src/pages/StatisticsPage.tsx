      ...
      <div className="w-full space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-4 w-full">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              className="px-3 py-1 rounded bg-[#1f1f22] hover:bg-[#2a2a2d]"
              onClick={() =>
            ...
            <button
              className="px-3 py-1 rounded bg-[#1f1f22] hover:bg-[#2a2a2d]"
              onClick={() =>
                setDateRange({ startDate: dayjs().startOf("year").toDate(), endDate: dayjs().endOf("year").toDate() })
              }
            >
              Год
            </button>
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1 px-3 py-1 rounded bg-[#1f1f22] hover:bg-[#2a2a2d]"
              >
