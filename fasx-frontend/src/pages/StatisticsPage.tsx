    ...
    <div className="min-h-screen bg-[#0f0f0f] text-gray-200 p-6 w-full">
      <div className="max-w-[1600px] mx-auto space-y-6 px-4">
        ...
        {reportType === "Общий отчет" && (
          <div className="bg-[#1a1a1d] p-5 rounded-2xl shadow-lg">
            <Bar data={enduranceData} options={{ responsive: true, plugins: { legend: { labels: { color: "#fff" } }, tooltip: { mode: "index", intersect: false } }, scales: { x: { ticks: { color: "#fff" } }, y: { ticks: { color: "#fff" } } }, interaction: { mode: "nearest", axis: "x", intersect: false }, stacked: true }} height={300}/>
          </div>
        )}
        {reportType === "Общая дистанция" && (
          <div className="bg-[#1a1a1d] p-5 rounded-2xl shadow-lg">
            <Bar data={distanceData} options={{ responsive: true, plugins: { legend: { labels: { color: "#fff" } }, tooltip: { mode: "index", intersect: false } }, scales: { x: { ticks: { color: "#fff" } }, y: { ticks: { color: "#fff" } } }, interaction: { mode: "nearest", axis: "x", intersect: false }, stacked: true }} height={300}/>
          </div>
        )}
