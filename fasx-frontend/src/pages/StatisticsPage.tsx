...
export default function StatsPage() {
  ...
  const totals = {
    ...
    sessions: 128,
    time: "178:51",
    distance: 1240, // NEW — расстояние в км
  };
        ...
        >
          ...
          >
            ...
            <div className="flex bg-[#222] border-b border-[#2a2a2a] sticky top-0 box-border z-10">
              ...
              <div
                className="p-3 text-center font-medium bg-[#1f1f1f] box-border flex-none"
                ...
                >
                  ...
                  {filteredMonths.map(
                    (val: number | string, k: number) => (
                      ...
                      >
                        {table.title === "Параметры дня"
                          ? row.months[k] // ← числа без времени
...
{/* Диаграмма зон выносливости — вставляем ПЕРЕД TOTALSUM */}
<div className="bg-[#1a1a1d] p-5 rounded-2xl shadow-lg">
