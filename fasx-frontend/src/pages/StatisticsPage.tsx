  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] text-gray-200 p-6 flex justify-center">
      <div className="w-full max-w-6xl space-y-8">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                data={filteredMonths.map((month, i) => {
                  ...
                  filteredEnduranceZones.forEach(
                    (zone) => (data[zone.zone] = zone.months[i])
                  );
                  return data;
                })}
                barSize={35}
          ...
          <table className="w-full text-sm text-gray-300 border-collapse">
            ...
            <tbody>
              {filteredMonths.map((m, i) => (
                <tr
                  key={m}
                  className="border-b border-gray-800 hover:bg-[#2a2a2d]"
                >
                  <td className="py-2">{m}</td>
                  <td>{Math.floor(Math.random() * 10) + 5}</td>
                  <td>{formatTime(Math.floor(Math.random() * 400))}</td>
        ...
        <div className="bg-[#1a1a1d] p-5 rounded-2xl shadow-lg mb-10">
          <h2 className="text-lg font-semibold mb-4 text-gray-100">
            Форма активности
          </h2>
          <table className="w-full text-sm text-gray-300 border-collapse">
